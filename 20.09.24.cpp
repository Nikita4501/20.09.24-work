	...
	if (a == 1)
	{
		...
		if (a == 0)
		{
			...
			if (a == 2)
			{
				...
				cin >> c;
				s = b * c;
				cout << "Произведение двух чисел  = " << s << endl;
			}
			else
				if (a == 3)
				{
					...
					{
						s = b - c;
						cout << "Разность двух чисел  = " << s << endl;
					}
					...
					if (a == 4)
					{
						...
						cin >> c;
						s = b / c;
						cout << "Частное двух чисел  = " << s << endl;
					}
					else
						if (a == 5)
						{
